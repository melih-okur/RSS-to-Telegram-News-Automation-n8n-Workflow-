# 📡 RSS'ten Telegram'a Otomasyon (n8n Workflow)

Bu proje, **n8n** kullanarak birden fazla RSS kaynağından haberleri toplayıp **Telegram botu** üzerinden otomatik olarak paylaşan bir workflow içerir.  
